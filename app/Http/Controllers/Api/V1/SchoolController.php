    ...
    public function online_admission_application(Request $request, SmsSendController $sms_send){
      ...
      $validator = Validator::make($data, [
        ...
        $data['online_admission_id']=$admission->id;
         ...
         if ($application->id) {
           $content='প্রিয় '.$data['name_bn'].' আপনার এডমিট ডাওনলোড লগইন তথ্য ! ওয়েব এড্রেস : '.$school->website.'/admit_card_check , রেজিস্ট্রেশন নং : '.$data['reg_no'].', পাসওয়ার্ড : '.$data['password'].' ';
