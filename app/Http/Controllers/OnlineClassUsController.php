...
class OnlineClassUsController extends Controller
{
    ...
    public function add_multiple_teacher_store(Request $request)
    {
       ...
       if($teacher)
        ...
        return $this->returnWithSuccessRedirect('আপনার তথ্য সংরক্ষণ হয়েছে !','online_class_us/index/'.$data->school_id);
    ...
    public function staff_class()
    {
        ...
        $online_class=OnlineClassUs::with('online_class_teacher1')->where(['school_id'=>Auth::getSchool()])->whereIn('type',[2,3])->get();
        //dd($online_class);
