...
class everyDay extends Command
{
    ...
    public function handle()
    {
        ...
        foreach($schools as $key => $school_id) {
            $day = Holiday::where('school_id',$school_id)->whereDate('date',date('Y-m-d'))->first();
    ...
    protected function student_attendance($day,$school_id){
        $students = Student::where('school_id',$school_id)->current()->get();
    ...
    protected function employee_attendance($day,$school_id){
