...
class MessageLengthController extends Controller
{
    ...
    public function store(Request $request){
		...
		return redirect()->route('messageLength.list')->with('sccmgs','বার্তার লিমিট সফলভাবে যোগ করা হয়েছে ।');
	}
    ...
    public function update(Request $request, $id){
       ...
       return redirect()->route('messageLength.list')->with('sccmgs','বার্তার লিমিট সফলভাবে আপডেট করা হয়েছে ।');
   }

    public function delete($id){
       MessageLength::find($id)->delete();
       return redirect()->route('messageLength.list')->with('sccmgs','বার্তার লিমিটা সফলভাবে মুছে ফেলা হয়েছে ।');
   }
