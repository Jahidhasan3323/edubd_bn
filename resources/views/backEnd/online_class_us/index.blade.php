...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            ...
            @if(Auth::is('root'))
                <a style="margin-left: 5px" class="btn btn-info pull-right" href="{{url('online_class_us/create/'.$school_id)}}"><i class="fa fa-plus"></i>  শিক্ষার্থীদের ক্লাস যোগ করুন</a> 
                <a style="margin-left: 5px" class="btn btn-warning pull-right" href="{{url('online_class_us/create_guardian/'.$school_id)}}"><i class="fa fa-plus"></i> অভিভাবকদের মিটিং যোগ করুন</a>
                <a class="btn btn-success pull-right" href="{{url('online_class_us/create_staff/'.$school_id)}}"><i class="fa fa-plus"></i> কর্মচারীদের মিটিং যোগ করুন</a>
            @endif
            </h1>
        </div>
