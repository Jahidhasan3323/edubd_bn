...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        ...
        <h4 class=" text-temp text-center"><b>টাইটেল:</b> {{$online_class->title}}, <b>শিফট :</b> {{$online_class->shift}}, <b>Group :</b> {{$online_class->group}}, <b>শ্রেণী :</b> {{$online_class->masterClass->name}}</h4>
        </div>
