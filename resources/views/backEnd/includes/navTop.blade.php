...
{{--      <a href="" class="btn btn-danger square-btn-adjust oc-mb">ইহসান অনলাইন কনফারেন্স</a>
 --}}        @yield('changePassword')
    ...
    <div class="navTopUser oc-dextop" style="color: white; padding: 10px 50px 5px 50px; float: right; font-size: 16px;">
        ...
        <a href="{{url('online_class_us/student')}}" class="btn btn-danger square-btn-adjust pull-left">ইহসান অনলাইন কনফারেন্স</a> 
        @endif
        @if(Auth::is('teacher')  || Auth::is('commitee') || Auth::is('staff') )
        <a href="#" class="pull-left" style="margin-right:5px"><i class="fa fa-spinner fa-spin"></i></a>  
            <a href="{{url('online_class_us/staff')}}" class="btn btn-danger square-btn-adjust pull-left">ইহসান অনলাইন কনফারেন্স</a> 
        @endif
        @if ( Auth::is('admin'))
        <a href="#" class="pull-left" style="margin-right:5px"><i class="fa fa-spinner fa-spin"></i></a>  
        <a href="{{url('online_class_us/school_class')}}" class="btn btn-danger square-btn-adjust pull-left">ইহসান অনলাইন কনফারেন্স</a> 
        @endif
    </div>
</nav>