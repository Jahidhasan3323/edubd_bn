                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{$errors->has('question') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('question')}}" class="form-control" type="text" name="question" id="question" placeholder="প্রশ্ন" data-validation="required length" data-validation-length="max100">
                            </div>
