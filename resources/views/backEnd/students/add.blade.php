                ...
                <div class="row">
                        ...
                        <div class="form-group {{$errors->has('religion') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <select class="form-control" name="religion" id="religion">
                                    ...
                                    <option selected value="ইসলাম">ইসলাম</option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('birth_rg_no') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('birth_rg_no','ফর্মে নাই')}}" class="form-control" type="text" name="birth_rg_no" id="birth_rg_no" placeholder="Student Birth Registration No">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_vpm') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_vpm','ফর্মে নাই')}}" type="text" class="form-control" name="pre_vpm" id="pre_vpm">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_poff') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_poff','ফর্মে নাই')}}" type="text" class="form-control" name="pre_poff" id="pre_poff" placeholder="Student Post office">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_unim') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_unim','ফর্মে নাই')}}" type="text" class="form-control" name="pre_unim" id="pre_unim" placeholder="Student Union / Municipality">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_subd') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_subd','ফর্মে নাই')}}" type="text" class="form-control" name="pre_subd" id="pre_subd" placeholder="Student Sub District / Thana">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_district') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_district','ফর্মে নাই')}}" type="text" class="form-control" name="pre_district" id="pre_district" placeholder="Student District">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('father_name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('father_name','ফর্মে নাই')}}" class="form-control" type="text" name="father_name" id="father_name" placeholder="Student Fater name">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('f_career') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('f_career','ফর্মে নাই')}}" class="form-control" type="text" name="f_career" id="f_career" placeholder="Student Father Career">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('mother_name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('mother_name','ফর্মে নাই')}}" class="form-control" type="text" name="mother_name" id="mother_name" placeholder="Student Mother Name">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('m_career') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('m_career','ফর্মে নাই')}}" class="form-control" type="text" name="m_career" id="m_career" placeholder="Mother Career">
                            </div>
