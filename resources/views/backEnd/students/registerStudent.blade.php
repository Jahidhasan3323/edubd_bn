                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('name')}}" class="form-control" type="text" name="name" id="name" placeholder="শিক্ষার্থীর নাম">
                            </div>
                            @if ($errors->has('name'))
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('roll') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('roll')}}" type="number" class="form-control" name="roll" id="roll" placeholder="শ্রেণী রোল নং">
                            </div>
                            @if ($errors->has('roll'))
                                <span class="help-block">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('session') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{date('Y')}}" type="text" class="form-control" name="session" id="session" placeholder="শিক্ষাবর্ষ">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('email',$student_id.'@gmail.com')}}" class="form-control" type="email" name="email" id="email" placeholder="ইমেইল">
                            </div>
                            @if ($errors->has('email'))
                                <span class="help-block">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('password') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input class="form-control" type="text" name="password" value="{{ rand(10, 999999999) }}" id="password" placeholder="পাসওয়ার্ড">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('birth_rg_no') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('birth_rg_no')}}" class="form-control" type="text" name="birth_rg_no" id="birth_rg_no" placeholder="জন্ম নিবন্ধন নাম্বার">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('last_sd_org') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('last_sd_org')}}" class="form-control" type="text" name="last_sd_org" id="last_sd_org" placeholder="সর্বশেষ অধ্যয়ন প্রতিষ্ঠানের নাম ও ঠিকানা">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('re_to_lve') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('re_to_lve')}}" class="form-control" type="text" name="re_to_lve" id="re_to_lve" placeholder="ছেড়ে আসার কারন">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_address') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_address')}}" type="text" class="form-control" name="pre_address" id="pre_address" placeholder="হোম নাম">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('Pre_h_no') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('Pre_h_no')}}" type="text" class="form-control" name="Pre_h_no" id="Pre_h_no" placeholder="হাউস / হোল্ডিং নম্বর">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_ro_no') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_ro_no')}}" type="text" class="form-control" name="pre_ro_no" id="pre_ro_no" placeholder="রাস্তা নম্বর">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_vpm') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_vpm')}}" type="text" class="form-control" name="pre_vpm" id="pre_vpm" placeholder="গ্রাম / পারা / মহল্লা নাম">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_unim') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_unim')}}" type="text" class="form-control" name="pre_unim" id="pre_unim" placeholder="ইউনিয়ন / পৌরসভার নাম">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_subd') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_subd')}}" type="text" class="form-control" name="pre_subd" id="pre_subd" placeholder="উপ জেলা / থানা নাম">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_postc') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_postc')}}" type="number" class="form-control" name="pre_postc" id="pre_postc" placeholder="পোস্ট কোড নং">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_address') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_address')}}" type="text" class="form-control" name="per_address" id="per_address" placeholder="হোম নাম ">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_h_no') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_h_no')}}" type="text" class="form-control" name="per_h_no" id="per_h_no" placeholder="হাউস / হোল্ডিং নম্বর">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_ro_no') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_ro_no')}}" type="text" class="form-control" name="per_ro_no" id="per_ro_no" placeholder="রাস্তা নম্বর">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_vpm') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_vpm')}}" type="text" class="form-control" name="per_vpm" id="per_vpm" placeholder="গ্রাম / পারা / মহল্লা নাম">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_unim') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_unim')}}" type="text" class="form-control" name="per_unim" id="per_unim" placeholder="ইউনিয়ন / পৌরসভার নাম">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_subd') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_subd')}}" type="text" class="form-control" name="per_subd" id="per_subd" placeholder="উপ জেলা / থানা নাম">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_postc') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_postc')}}" type="number" class="form-control" name="per_postc" id="per_postc" placeholder="পোস্ট কোড নং">
                            </div>
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-6">
                         <div class="form-group {{$errors->has('f_email') ? 'has-error' : ''}}">
                             ...
                             <div class="">
                                 <input value="{{old('f_email')}}" class="form-control" type="text" name="f_email" id="f_email" placeholder="ইমেইল">
                             </div>
                 ...
                 <div class="row">
                     <div class="col-sm-12">
                         <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                             ...
                             <div class="">
                                 <input value="{{old('f_nid')}}" class="form-control" type="text" name="f_nid" id="f_nid" placeholder="জাতীয় পরিচয় পত্র / পাসপোর্ট / ড্রাইভিং লাইসেন্সের নাম্বার">
                             </div>
                              @if ($errors->has('f_nid'))
                                 <span class="help-block">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('m_edu_quali')}}" class="form-control" type="text" name="m_edu_quali" id="m_edu_quali" placeholder="শিক্ষাগত যোগ্যতা">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('m_email')}}" class="form-control" type="text" name="m_email" id="m_email" placeholder="ইমেইল">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('m_nid') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('m_nid')}}" class="form-control" type="text" name="m_nid" id="m_nid" placeholder="জাতীয় পরিচয় পত্র / পাসপোর্ট / ড্রাইভিং লাইসেন্সের নাম্বার">
                            </div>
                             @if ($errors->has('m_nid'))
                                <span class="help-block">
               ...
               <div class="row">
                   <div class="col-sm-12">
                       <div class="form-group {{$errors->has('local_gar') ? 'has-error' : ''}}">
                           ...
                           <div class="">
                               <input value="{{old('local_gar')}}" class="form-control" type="text" name="local_gar" id="local_gar" placeholder="পিতা / মাতার অবর্তমানে স্থানীয় অভিভাবকের নাম ">
                           </div>
               ...
               <div class="row">
                   <div class="col-sm-6 {{$errors->has('career') ? 'has-error' : ''}}">
                       <div class="form-group">
                           ...
                           <div class="">
                               <input value="{{old('career')}}" class="form-control" type="text" name="career" id="career" placeholder="পেশা">
                           </div>
                       </div>
                   ...
                   <div class="col-sm-6">
                       <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                           ...
                           <div class="">
                               <input value="{{old('relation')}}" class="form-control" type="text" name="relation" id="relation" placeholder="সম্পর্ক">
                           </div>
                           @if ($errors->has('relation'))
                               <span class="help-block">
               ...
               <div class="row">
                   <div class="col-sm-6 {{$errors->has('guardian_edu') ? 'has-error' : ''}}">
                       <div class="form-group">
                           ...
                           <div class="">
                               <input value="{{old('guardian_edu')}}" class="form-control" type="text" name="guardian_edu" id="guardian_edu Educational Qualification" placeholder="শিক্ষাগত যোগ্যতা">
                           </div>
                       </div>
                   ...
                   <div class="col-sm-6">
                       <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                           ...
                           <div class="">
                               <input value="{{old('guardian_mobile')}}" class="form-control" type="number" name="guardian_mobile" id="guardian_mobile" placeholder="ফোন নাম্বার">
                           </div>
               ...
               <div class="row">
                   <div class="col-sm-6 {{$errors->has('guardian_email') ? 'has-error' : ''}}">
                       <div class="form-group">
                           ...
                           <div class="">
                               <input value="{{old('guardian_email')}}" class="form-control" type="text" name="guardian_email" id="guardian_email" placeholder="ইমেইল">
                           </div>
                       </div>
                   ...
                   <div class="col-sm-6">
                       <div class="form-group {{$errors->has('guardian_nid') ? 'has-error' : ''}}">
                           ...
                           <div class="">
                               <input value="{{old('guardian_nid')}}" class="form-control" type="text" name="guardian_nid" id="guardian_nid" placeholder="জাতীয় পরিচয় পত্র / পাসপোর্ট / ড্রাইভিং লাইসেন্সের নাম্বার">
                           </div>
