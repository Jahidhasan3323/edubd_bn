...
<div class="panel col-md-12" style="margin-top: 15px; margin-bottom: 15px;">
    <div class="page-header">
        <h1 class="text-center text-temp">শিক্ষক ও কর্মচারীদের ইমেইল রিসেট</h1>
    </div>
    ...
    @if(isset($employees))
    <div class="col-sm-12">
        <h4 style="margin-bottom: 10px;" class="text-center"> শিক্ষক ও কর্মচারী নির্বাচন করুন </h4>
                            ...
                            <div class="">
                                <div class="row">
                                    <div class="col-md-2 col-md-offset-5">
                                        <div class="form-group">
                                            <button id="save_btn" type="submit" class="btn btn-block btn-info">ইমেইল রিসেট</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
