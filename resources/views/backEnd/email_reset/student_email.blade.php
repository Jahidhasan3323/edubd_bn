...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">শিক্ষার্থীদের ইমেইল রিসেট</h1>
        </div>
        ...
        @endif
        <div class="col-md-12">
            <h4 style="margin-bottom: 20px;" class="text-center">সব নির্বাচন করুন</h4>
            <div class="row">
        ...
        <h5 style="margin-bottom: 10px;" class="text-center">মোট শিক্ষার্থীঃ {{count($students)}}</h5>
        <div class="row">
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-2 col-md-offset-5">
                                <div class="form-group">
                                    <button id="save_btn" type="submit" class="btn btn-block btn-info">ইমেইল রিসেট করুন</button>
                                </div>
                            </div>
                        </div>
                    </div>
				  ...
				  $.ajax({
					  ...
					  success: function (data) {
						  ...
						  if (data.length){
							  ...
							  var option1 = '<option>শ্রেণী পাওয়া যায়নি !</option>';
