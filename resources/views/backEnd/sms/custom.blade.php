...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">কাস্টম নাম্বারে বিজ্ঞপ্তি সেবা</h1>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="" for="text_status">মোবাইল নাম্বার <small>(প্রতিটি নাম্বার কমা দিয়ে আলাদা করুন)</small></label>
                                        <div class="">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button id="save_btn" type="submit" class="btn btn-info">এসএমএস প্রেরণ করুন </button>
                                    </div>
                                </div>
                            </div>
                        </div>
